...
Names are `agarwal`, `sdt`, `conan`, `matusiak`, `poirot`, `continuous`, `matusiak2024`, and `falaize`.
...
Matusiak 2024 compares published force traces, and Falaize–Roze compares figures.
